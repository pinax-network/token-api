...
const querySchema = z
    .object({
        ...
        contract: createBatchedSchema(PudgyPenguins).optional(),
        token_id: createBatchedSchema(PudgyPenguinsItem).optional(),
        address: createBatchedSchema(evmAddressSchema).optional(),
