...
const querySchema = createQuerySchema({
    ...
    pool: { schema: evmPoolSchema, batched: true, default: null, meta: { example: EVM_POOL_USDC_WETH_EXAMPLE } },
    caller: { schema: evmAddressSchema, batched: true, default: null, meta: { example: EVM_ADDRESS_SWAP_EXAMPLE } },
    sender: { schema: evmAddressSchema, batched: true, default: null, meta: { example: EVM_ADDRESS_SWAP_EXAMPLE } },
    recipient: { schema: evmAddressSchema, batched: true, default: null, meta: { example: EVM_ADDRESS_SWAP_EXAMPLE } },
    input_contract: {
    ...
    protocol: { schema: evmProtocolSchema, default: null },
