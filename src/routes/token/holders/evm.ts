...
import { evmAddressSchema, statisticsSchema, paginationQuery, orderBySchemaAmount, GRT, networkIdSchema, orderDirectionSchema } from '../../../types/zod.js';
...
const querySchema = z.object({
    ...
    orderBy: z.optional(orderBySchemaAmount),
